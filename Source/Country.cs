...
namespace Codenation.Challenge
{
    ...
    {
        public State[] Top10StatesByArea() => GetBrazilianStates()
            .OrderByDescending(state => state.Territory)
            .Take(10)
            .ToArray();
        ...
        private List<State> GetBrazilianStates() =>
            new List<State>()
            {
                ...
                new State("Maranhão", "MA", 331937.45),
                ...
                new State("Tocantins", "TO", 277720.52)
            };
    }
}
